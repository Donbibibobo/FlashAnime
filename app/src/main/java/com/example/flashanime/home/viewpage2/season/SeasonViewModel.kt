...
//
                    ...
                    playWordEpisode.add(PlayWordEpisode("1",playWordsList1)) //every playWordsList is episode one's words
//                    playWordEpisode.add(PlayWordEpisode("2",playWordsList1))
//                    playWordEpisode.add(PlayWordEpisode("3",playWordsList1))
//                    playWordEpisode.add(PlayWordEpisode("4",playWordsList1))
//                    playWordEpisode.add(PlayWordEpisode("5",playWordsList1))
//                    playWordEpisode.add(PlayWordEpisode("6",playWordsList1))
//                    playWordEpisode.add(PlayWordEpisode("7",playWordsList1))
//                    playWordEpisode.add(PlayWordEpisode("8",playWordsList1))
//                    playWordEpisode.add(PlayWordEpisode("9",playWordsList1))
//                    playWordEpisode.add(PlayWordEpisode("10",playWordsList1))
//                    playWordEpisode.add(PlayWordEpisode("11",playWordsList1))
//                    playWordEpisode.add(PlayWordEpisode("12",playWordsList1))


                    val typeList = listOf<String>("有趣")
                    val m3u8UrlsType1 = listOf<String>("x")
                    val image = "a"
